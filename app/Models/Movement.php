 ...
 * @OA\Property(property="category", type="string", maxLength=255, description="Nombre de la categoría (last_rule_id) que se aplica en ese movimiento", example="FLUSHING"),
