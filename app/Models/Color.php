 ...
 * @OA\Property(property="name", type="string", maxLength=255, description="Nombre específico del color", example="RUBY RED"),
 * @OA\Property(property="code", type="string", maxLength=255, description="Código de color", example="RYBB"),
 * @OA\Property(property="simple_name", type="string", maxLength=255, description="Nombre básico del color", example="RED"),
 * @OA\Property(property="hex", type="string", maxLength=255, description="Código hexadecimal del color", example="#9b111e"),
