 ...
 * @OA\Property(property="name", type="string", maxLength=255, description="Nombre del país", example="GERMANY"),
 * @OA\Property(property="code", type="string", maxLength=255, description="Código del país", example="GK"),
