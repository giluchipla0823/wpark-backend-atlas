...
class Vehicle extends Model
{
    ...
    {
        return $this->belongsToMany(Stage::class, 'vehicles_stages', 'vehicle_id', 'stage_id')->withPivot('manual', 'tracking_date')->withTimestamps()->orderByPivot('created_at', 'desc')->take(1);
    }
