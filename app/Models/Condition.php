 ...
 * @OA\Property(property="active", type="boolean", maxLength=1, description="Indica si la condición está activa (0: No está activa, 1: Está activa", example="1"),
...
class Condition extends Model
{
    ...
    {
        return $this->belongsToMany(Hold::class, 'holds_conditions', 'hold_id', 'condition_id')->wherePivotNull('deleted_at')->withTimestamps();
    }

    public function rules()
    {
        return $this->morphedByMany(Rule::class, 'rules_conditions')->wherePivotNull('deleted_at')->withTimestamps();
    }
}
