 ...
 *
 * @OA\Schema(
 * required={"name", "area_id", "parking_type_id", "start_row", "end_row", "start_column", "end_column", "capacity", "fill", "capacitymm", "filmm", "full", "active"},
 * @OA\Xml(name="Parking"),
 ...
 * @OA\Property(property="capacitymm", type="integer", maxLength=10, description="Altura del modelo", example="400.000"),
