...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        ...
        .button--blue {
            ...
            border-top: 10px solid #1a439c;
            border-right: 18px solid #1a439c;
            border-bottom: 10px solid #1a439c;
            border-left: 18px solid #1a439c;
        }
                                    ...
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>You recently requested to reset your password for your
                                                {{ env('APP_NAME') }} account. Use the button below to reset it.
                                                <strong>This password reset is only valid for the next 24
                                                    hours.</strong></p>
                                            <!-- Action -->
                                            ...
                                            <p>For security, if you did not request a password reset, please ignore this
                                                email or <a href="{{ env('MAIL_FROM_ADDRESS') }}">contact support</a> if
